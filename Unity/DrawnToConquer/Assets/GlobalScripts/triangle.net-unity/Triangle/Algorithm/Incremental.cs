...
namespace TriangleNet.Algorithm
{
    ...
    class Incremental
    {
        ...
        void GetBoundingBox()
        {
            ...
            TriangleNetMesh.dummytri.neighbors[0] = inftri;
        }
        ...
        int RemoveBox()
        {
            ...
            nextedge.triangle = TriangleNetMesh.dummytri;
            nextedge.orient = 0;
            nextedge.SymSelf();
            ...
            checkedge.SymSelf();
            if (checkedge.triangle == TriangleNetMesh.dummytri)
            {
            ...
            TriangleNetMesh.dummytri.neighbors[0] = searchedge;
            hullsize = -2;
            while (!nextedge.Equal(finaledge))
            {
                ...
                if (noPoly)
                {
                    ...
                    if (dissolveedge.triangle != TriangleNetMesh.dummytri)
                    {
                ...
                if (nextedge.triangle == TriangleNetMesh.dummytri)
                {
                    // Turn the corner.
        ...
        public int Triangulate(TriangleNetMesh mesh)
        {
            this.mesh = mesh;
            ...
            {
                starttri.triangle = TriangleNetMesh.dummytri;
