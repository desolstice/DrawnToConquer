...
namespace TriangleNet
{
    ...
    public class TriangleNetMesh
    {
        ...
        /// Initializes a new instance of the <see cref="TriangleNetMesh" /> class.
        /// </summary>
        public TriangleNetMesh(Behavior behavior)
        {
        ...
        internal void Flip(ref Otri flipedge)
        {
            ...
            if (checksegments)
            {
                ...
                if (toplsubseg.seg == TriangleNetMesh.dummysub)
                {
                    topright.SegDissolve();
                }
                else
                ...
                if (botlsubseg.seg == TriangleNetMesh.dummysub)
                {
                    topleft.SegDissolve();
                }
                else
                ...
                if (botrsubseg.seg == TriangleNetMesh.dummysub)
                {
                    botleft.SegDissolve();
                }
                else
                ...
                if (toprsubseg.seg == TriangleNetMesh.dummysub)
                {
                    botright.SegDissolve();
                }
                else
        ...
        internal void DeleteVertex(ref Otri deltri)
        {
            ...
            if (leftsubseg.seg != TriangleNetMesh.dummysub)
            {
                deltri.SegBond(ref leftsubseg);
            }
            righttri.SegPivot(ref rightsubseg);
            if (rightsubseg.seg != TriangleNetMesh.dummysub)
            {
        ...
        internal void UndoVertex()
        {
            ...
            while (flipstack.Count > 0)
            {
                ...
                else if (flipstack.Peek().triangle == null) // Dummy flip
                {
                    ...
                    if (gluetri.triangle != TriangleNetMesh.dummytri)
                    {
                        gluetri.LnextSelf();
        ...
        private FindDirectionResult FindDirection(ref Otri searchtri, Vertex searchpoint)
        {
            ...
            if (leftflag && rightflag)
            {
                ...
                if (checktri.triangle == TriangleNetMesh.dummytri)
                {
                    leftflag = false;
                }
                else
        ...
        private void SegmentIntersection(ref Otri splittri, ref Osub splitsubseg, Vertex endpoint2)
        {
            ...
            while (splitsubseg.seg != TriangleNetMesh.dummysub);
            do
            {
                opposubseg.SetSegOrg(newvertex);
                opposubseg.NextSelf();
            }
            while (opposubseg.seg != TriangleNetMesh.dummysub);
        ...
        private bool ScoutSegment(ref Otri searchtri, Vertex endpoint2, int newmark)
        {
            ...
            else
            {
                ...
                if (crosssubseg.seg == TriangleNetMesh.dummysub)
                {
                    return false;
                }
                else
        ...
        private void DelaunayFixup(ref Otri fixuptri, bool leftside)
        {
            ...
            if (fartri.triangle == TriangleNetMesh.dummytri)
            {
                return;
            }
            neartri.SegPivot(ref faredge);
            if (faredge.seg != TriangleNetMesh.dummysub)
            {
                return;
            }
        ...
        private void InsertSegment(Vertex endpoint1, Vertex endpoint2, int newmark)
        {
            ...
            if (checkvertex != endpoint1)
            {
                ...
                searchtri1.triangle = TriangleNetMesh.dummytri;
                searchtri1.orient = 0;
                searchtri1.SymSelf();
            ...
            {
                // Find a boundary triangle to search from.
                searchtri2.triangle = TriangleNetMesh.dummytri;
                searchtri2.orient = 0;
                searchtri2.SymSelf();
        ...
        private void MarkHull()
        {
            ...
            hulltri.triangle = TriangleNetMesh.dummytri;
            hulltri.orient = 0;
            hulltri.SymSelf();
            ...
            do
            {
                ...
                while (nexttri.triangle != TriangleNetMesh.dummytri)
                {
