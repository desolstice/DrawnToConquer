...
namespace TriangleNet.Data
{
    ...
    public class Triangle : ITriangle
    {
        ...
        public Triangle()
        {
            ...
            neighbors[0].triangle = TriangleNetMesh.dummytri;
            neighbors[1].triangle = TriangleNetMesh.dummytri;
            neighbors[2].triangle = TriangleNetMesh.dummytri;
            ...
            // TODO: if (Behavior.UseSegments)
            {
                ...
                subsegs = new Osub[3];
                subsegs[0].seg = TriangleNetMesh.dummysub;
                subsegs[1].seg = TriangleNetMesh.dummysub;
                subsegs[2].seg = TriangleNetMesh.dummysub;
            }
        ...
        {
            return neighbors[index].triangle == TriangleNetMesh.dummytri ? null : neighbors[index].triangle;
        }
        ...
        {
            return subsegs[index].seg == TriangleNetMesh.dummysub ? null : subsegs[index].seg;
        }
