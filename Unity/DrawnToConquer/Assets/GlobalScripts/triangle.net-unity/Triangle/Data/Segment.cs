...
namespace TriangleNet.Data
{
    ...
    public class Segment : ISegment
    {
        ...
        public Segment()
        {
            ...
            triangles[0].triangle = TriangleNetMesh.dummytri;
            triangles[1].triangle = TriangleNetMesh.dummytri;
        ...
        {
            return triangles[index].triangle == TriangleNetMesh.dummytri ? null : triangles[index].triangle;
        }
