...
namespace TriangleNet.IO
{
    ...
    static class DataReader
    {
        ...
        /// </remarks>
        public static int Reconstruct(TriangleNetMesh mesh, InputGeometry input, ITriangle[] triangles)
        {
            int hullsize = 0;
            ...
            for (i = 0; i < mesh.vertices.Count; i++)
            {
                ...
                tmp.triangle = TriangleNetMesh.dummytri;
            ...
            foreach (var item in mesh.triangles.Values)
            {
                ...
                for (tri.orient = 0; tri.orient < 3; tri.orient++)
                {
                    ...
                    if (checktri.triangle != TriangleNetMesh.dummytri)
                    {
                        ...
                        while (checktri.triangle != TriangleNetMesh.dummytri);
                    }
                }
            ...
            if (mesh.behavior.Poly)
            {
                ...
                foreach (var item in mesh.subsegs.Values)
                {
                    ...
                    for (subseg.orient = 0; subseg.orient < 2; subseg.orient++)
                    {
                        ...
                        while (notfound && (checktri.triangle != TriangleNetMesh.dummytri))
                        {
                            checkdest = checktri.Dest();
                            ...
                            if (shorg == checkdest)
                            {
                                ...
                                if (checkneighbor.triangle == TriangleNetMesh.dummytri)
                                {
