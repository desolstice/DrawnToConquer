...
namespace TriangleNet.IO
{
    ...
    class DebugWriter
    {
        ...
        /// </summary>
        public void Write(TriangleNetMesh mesh, bool skip = false)
        {
        ...
        private void WriteMesh(TriangleNetMesh mesh, bool skip)
        {
        ...
        private bool VerticesChanged(TriangleNetMesh mesh)
        {
        ...
        private void HashVertices(TriangleNetMesh mesh)
        {
            if (vertices == null || mesh.Vertices.Count != vertices.Length)
            {
