...
namespace TriangleNet.IO
{
    ...
    public static class FileWriter
    {
        ...
        public static void Write(TriangleNetMesh mesh, string filename)
        {
        ...
        /// <param name="mesh"></param>
        /// <param name="filename"></param>
        public static void WriteNodes(TriangleNetMesh mesh, string filename)
        {
        ...
        /// Number the vertices and write them to a .node file.
        /// </summary>
        private static void WriteNodes(StreamWriter writer, TriangleNetMesh mesh)
        {
        ...
        /// <param name="mesh"></param>
        /// <param name="filename"></param>
        public static void WriteElements(TriangleNetMesh mesh, string filename)
        {
        ...
        /// <param name="mesh"></param>
        /// <param name="filename"></param>
        public static void WritePoly(TriangleNetMesh mesh, string filename)
        {
        ...
        public static void WritePoly(TriangleNetMesh mesh, string filename, bool writeNodes)
        {
        ...
        /// <param name="mesh"></param>
        /// <param name="filename"></param>
        public static void WriteEdges(TriangleNetMesh mesh, string filename)
        {
            ...
            using (StreamWriter writer = new StreamWriter(filename))
            {
                ...
                foreach (var item in mesh.triangles.Values)
                {
                    ...
                    {
                        tri.Sym(ref trisym);
                        if ((tri.triangle.id < trisym.triangle.id) || (trisym.triangle == TriangleNetMesh.dummytri))
                        {
                            p1 = tri.Org();
                            p2 = tri.Dest();
                            ...
                            if (behavior.UseBoundaryMarkers)
                            {
                                ...
                                if (behavior.useSegments)
                                {
                                    ...
                                    if (checkmark.seg == TriangleNetMesh.dummysub)
                                    {
                                ...
                                {
                                    writer.WriteLine("{0} {1} {2} {3}", index, p1.id, p2.id,
                                        trisym.triangle == TriangleNetMesh.dummytri ? "1" : "0");
                                }
                            }
                            else
                            {
        ...
        public static void WriteNeighbors(TriangleNetMesh mesh, string filename)
        {
            Otri tri = default(Otri), trisym = default(Otri);
            int n1, n2, n3;
            int i = 0;
        ...
        public static void WriteVoronoi(TriangleNetMesh mesh, string filename)
        {
            Otri tri = default(Otri), trisym = default(Otri);
                ...
                foreach (var item in mesh.triangles.Values)
                {
                    ...
                    for (tri.orient = 0; tri.orient < 3; tri.orient++)
                    {
                        ...
                        if ((tri.triangle.id < trisym.triangle.id) || (trisym.triangle == TriangleNetMesh.dummytri))
                        {
                            ...
                            if (trisym.triangle == TriangleNetMesh.dummytri)
                            {
                                torg = tri.Org();
                                tdest = tri.Dest();
        ...
        /// </remarks>
        public static void WriteOffFile(TriangleNetMesh mesh, string filename)
        {
            Otri tri;
            Vertex p1, p2, p3;
